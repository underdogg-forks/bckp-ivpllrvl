...
{
    /**
     * @originalName generate_xml_invoice_file
     *
    ...
    /**
     * @originalName include_rdf
     *
     * @originalFile e-invoice_helper.php
     */
    public static function includeRdf(string $embedXml, string $urn = 'factur-x'): string
    {
    ...
    /**
     * @originalName get_xml_template_files
     *
     * @originalFile e-invoice_helper.php
     */
        ...
        foreach ($xml_config_files as $key => $xml_config_file) {
            ...
            if (file_exists($path . $xml_config_files[$key] . '.php') && include $path . $xml_config_files[$key] . '.php') {
                ...
                if (file_exists(APPPATH . 'libraries/XMLtemplates/' . $generator . 'Xml.php')) {
                    ...
                    $xml_template_items[$xml_config_files[$key]] = $xml_setting['full-name'] . ' - ' . get_country_name(trans('cldr'), $xml_setting['countrycode']);
                }
            }
        }
    ...
    /**
     * @originalName get_xml_full_name
     *
     * @originalFile e-invoice_helper.php
     */
    ...
    /**
     * @originalName get_admin_active_users
     *
     * @originalFile e-invoice_helper.php
     */
    ...
    /**
     * @originalName get_req_fields_einvoice
     *
     * @originalFile e-invoice_helper.php
     */
    public static function getReqFieldsEinvoice($client = null, $user_id = ''): object
    {
        $cid = empty($client->client_id) ? 0 : $client->client_id;
        // Client is New (form) or exist
        $c = new stdClass();
    ...
    /**
     * @originalName get_einvoice_usage
     *
     * @originalFile e-invoice_helper.php
     */
    public static function getEinvoiceUsage($invoice, array $items, $full = true): object
    {
        ...
        if ($on) {
            ...
            if ($full) {
                ...
                $on = ! items_tax_usages_bad($items);
                // false or array ids[0] no taxes, ids[1] taxes + alert notification
            }
    ...
    /**
     * @originalName get_items_tax_usages
     *
     * @originalFile e-invoice_helper.php
     */
    public static function getItemsTaxUsages($items): array
    {
        $checks = [[], []];
    ...
    /**
     * @originalName items_tax_usages_bad
     *
     * @originalFile e-invoice_helper.php
     */
    public static function itemsTaxUsagesBad($items): mixed
    {
