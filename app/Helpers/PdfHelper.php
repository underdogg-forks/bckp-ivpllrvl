...
{
    /**
     * @originalName discount_global_print_in_pdf
     *
     * @originalFile pdf_helper.php
     */
    public static function discountGlobalPrintInPdf($obj, $show_item_discounts, string $is = 'invoice'): void
    {
        ...
        if ($discount) {
            ?>
            <tr>
                <td class="text-right" colspan="<?php
            echo $show_item_discounts ? '5' : '4';
            ?>"><?php
            echo mb_rtrim(trans('discount'), ' ');
            // Rem not space char (in French ip_lang & maybe other)
            ?></td>
...
<?php
    ...
    /**
     * @originalName generate_invoice_pdf
     *
     * @originalFile pdf_helper.php
     */
        ...
        if (get_setting('einvoicing')) {
            ...
            if ($xml_id && $embed_xml) {
                ...
                $associatedFiles = [[
                    ...
                    // GetController from generator or from config
                    'mime' => $_SERVER['CIImime'] ?? 'text/xml',
                    // GetController mime from generator
    ...
    /**
     * @originalName generate_invoice_sumex
     *
     * @originalFile pdf_helper.php
     */
    ...
    /**
     * @originalName generate_quote_pdf
     *
     * @originalFile pdf_helper.php
     */
