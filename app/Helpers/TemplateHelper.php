...
{
    /**
     * @originalName parse_template
     *
     * @originalFile template_helper.php
     */
    public static function parseTemplate($object, $body)
    {
    ...
    /**
     * @originalName get_invoice_status
     *
     * @originalFile template_helper.php
     */
    ...
    /**
     * @originalName select_pdf_invoice_template
     *
     * @originalFile template_helper.php
     */
    ...
    /**
     * @originalName select_email_invoice_template
     *
     * @originalFile template_helper.php
     */
