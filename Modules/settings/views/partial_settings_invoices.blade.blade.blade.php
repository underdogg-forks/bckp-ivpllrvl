...
@php
                        ...
                        <div class="form-group">
                            ...
                            <select name="settings[generate_invoice_number_for_draft]" class="form-control simple-select"
                                ...
                                <option value="1" @php check_select(get_setting('generate_invoice_number_for_draft'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="settings[mark_invoices_sent_pdf]" id="settings[mark_invoices_sent_pdf]"
                                ...
                                <option value="1" @php check_select(get_setting('mark_invoices_sent_pdf'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                ...
                <div class="row {{ $qr_code ? '' : 'hidden' }}">
                    <div class="col-xs-12">
                        <p class="alert alert-info no-padding">
                            <i class="fa fa-info"></i>@@lang('qr_code_settings_enable_hint_users')&nbsp;<i class="fa fa-qrcode"></i>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                class="form-control"
                                placeholder="@php _htmlsc(trans('company')); @endphp"
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="settings[automatic_email_on_recur]" id="settings[automatic_email_on_recur]"
                                ...
                                <option value="1" @php check_select(get_setting('automatic_email_on_recur'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[no_update_invoice_due_date_mail]" class="form-control simple-select"
                                ...
                                <option value="1" @php check_select(get_setting('no_update_invoice_due_date_mail'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                                <option value="0" @php check_select(get_setting('no_update_invoice_due_date_mail'), '0'); @endphp>
                                    @@lang('no')
                                </option>
                            </select>
                        </div>
