...
@php $this->layout->loadView('clients/js/script_select_client_title.js'); @endphp
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="client_invoicing_contact" id="client_invoicing_contact" class="form-control"
                                    value="{{ htmlsc($this->mdl_clients->form_value('client_invoicing_contact')) }}">
                            </div>
                        </div>
...
$is_custom_title = null === ClientTitleEnum::tryFrom($client_title); @endphp
...
@php foreach ($client_title_choices as $client_title_choice) {
    @endphp
                                <option
                                    ...
                                    {{ $is_custom_title && $client_title_choice === ClientTitleEnum::CUSTOM ? 'selected' : '' }}
                                >
...
@php
                        ...
                        <div class="form-group">
                            <input
                                ...
                                placeholder="@php _htmlsc(trans('custom_title')); @endphp"
                                value="@php _htmlsc($client_title); @endphp"
                            >
                        </div>
...
$bdate = $bdate && $bdate != '0000-00-00' ? date_from_mysql($bdate) : ''; @endphp
                            <div class="input-group">
                                <input type="text" name="client_birthdate" id="client_birthdate"
                                    ...
                                    value="@php _htmlsc($bdate); @endphp">
