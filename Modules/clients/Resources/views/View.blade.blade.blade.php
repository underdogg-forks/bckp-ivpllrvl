...
<div id="headerbar">
    <h1 class="headerbar-title">@php _htmlsc(format_client($client)); @endphp</h1>
        ...
        <div id="client-details" class="tab-pane tab-rich-content{{ $activeTab == 'detail' ? ' active' : '' }}">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8">
                    ...
                    <h3>@php _htmlsc(format_client($client)); @endphp</h3>
                    <p>@php $this->layout->loadView('clients/partial_client_address'); @endphp</p>
            ...
            <hr>
@php $colClass = 'col-xs-12 col-sm-6' . ($req_einvoicing ? ' col-lg-4' : ''); @endphp
            <div class="row">
                <div class="{{ $colClass }}">
...
@php if ($client->client_invoicing_contact) {
    ...
    @@lang('contact') }} (@@lang('invoicing'))</th>
                                    <td>@php
    _htmlsc($client->client_invoicing_contact);
    @endphp</td>
                                </tr>
@php
}
if ($client->client_email) {
    @endphp
                                <tr>
                                    <th>@@lang('email')</th>
                                    <td>@php
    _auto_link($client->client_email, 'email');
    @endphp</td>
                                </tr>
@php
}
...
if ($client->client_web) {
    @endphp
                                <tr>
                                    <th>@@lang('web')</th>
                                    <td>@php
    _auto_link($client->client_web, 'url', true);
    @endphp</td>
                                </tr>
@php
} @endphp
                    ...
                    <div class="panel panel-default no-margin">
                        ...
                        <div class="panel-body table-content">
                            <table class="table no-margin">
                                <tr>
                                    <th>@@lang('company')</th>
                                    <td>@php _htmlsc($client->client_company ? $client->client_company : ''); @endphp</td>
                                </tr>
...
if ($client->client_tax_code) {
    @endphp
                                <tr>
                                    <th>@@lang('tax_code')</th>
                                    <td>@php
    _htmlsc($client->client_tax_code);
    @endphp</td>
                                </tr>
@php
} @endphp
    ...
    @endphp
                        ...
                        <div class="panel-body table-content">
                            ...
                            <table class="table no-margin">
                                <tr>
                                    <th>e-@php
    _htmlsc(trans('invoice') . ' ' . trans('version') . ' (' . trans('send'));
    @endphp)</th>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">@@lang('personal_information')</div>
    ...
    if ($this->mdl_settings->setting('sumex') == '1') {
        @endphp
                                ...
                                <tr>
                                    ...
                                    <td>@php
        _htmlsc($client->client_insurednumber);
        @endphp</td>
                                </tr>
