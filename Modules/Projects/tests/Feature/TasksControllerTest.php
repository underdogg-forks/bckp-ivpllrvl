...
use Modules\Tasks\Tests\Feature\Invoice;
use Modules\Tasks\Tests\Feature\Task;
use Modules\Tasks\Tests\Feature\User;
...
class TasksControllerTest extends TestCase
{
    ...
    public function it_displays_tasks_list()
    {
        ...
        $task = \Modules\Projects\app\Models\Task::factory()->create();
