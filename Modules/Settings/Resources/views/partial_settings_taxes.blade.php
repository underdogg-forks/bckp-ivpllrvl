                    ...
                    <div class="w-full px-4 md:w-1/2">
                        ...
                        <div class="mb-4">
                            ...
                            >
                                ...
                                @foreach($tax_rates as $tax_rate)
                                    <option
                                        value="{{ $tax_rate->tax_rate_id }}" {!! check_select(get_setting('default_invoice_tax_rate'), $tax_rate->tax_rate_id) !!}>
                        ...
                        <div class="mb-4">
                            ...
                            >
                                ...
                                @foreach($tax_rates as $tax_rate)
                                    <option
                                        value="{{ $tax_rate->tax_rate_id }}" {!! check_select(get_setting('default_item_tax_rate'), $tax_rate->tax_rate_id) !!}>
                                        {{ $tax_rate->tax_rate_percent . '% - ' . $tax_rate->tax_rate_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="w-full px-4 md:w-1/2">
                            <div class="mb-4">
                                ...
                                >
                                    <option value="">@lang('none')</option>
                                    <option
                                        value="0" {!! check_select(get_setting('default_include_item_tax'), '0') !!}>
                                        @lang('apply_before_item_tax')
                                    </option>
                                    <option
                                        value="1" {!! check_select(get_setting('default_include_item_tax'), '1') !!}>
