                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[currency_symbol_placement]" id="settings[currency_symbol_placement]"
                                class="form-control simple-select" data-minimum-results-for-search="Infinity">
                                <option value="before" @php check_select(get_setting('currency_symbol_placement'), 'before'); @endphp>
                                    @@lang('before_amount')
                                </option>
                                <option value="after" @php check_select(get_setting('currency_symbol_placement'), 'after'); @endphp>
                                    @@lang('after_amount')
                                </option>
                                <option value="afterspace" @php check_select(get_setting('currency_symbol_placement'), 'afterspace'); @endphp>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[tax_rate_decimal_places]" class="form-control simple-select"
                                ...
                                <option value="2" @php check_select(get_setting('tax_rate_decimal_places'), '2'); @endphp>
                                    2
                                </option>
                                <option value="3" @php check_select(get_setting('tax_rate_decimal_places'), '3'); @endphp>
                                    3
                                </option>
                            </select>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[default_item_decimals]" id="settings[default_item_decimals]"
                                class="form-control simple-select"
                                data-minimum-results-for-search="Infinity">
                                <option value="1" @php check_select($current_default_item_decimals, '1'); @endphp>1</option>
                                <option value="2" @php check_select($current_default_item_decimals, '2'); @endphp>2</option>
                                <option value="3" @php check_select($current_default_item_decimals, '3'); @endphp>3</option>
                                <option value="4" @php check_select($current_default_item_decimals, '4'); @endphp>4</option>
                                <option value="5" @php check_select($current_default_item_decimals, '5'); @endphp>5</option>
                                <option value="6" @php check_select($current_default_item_decimals, '6'); @endphp>6</option>
                                <option value="7" @php check_select($current_default_item_decimals, '7'); @endphp>7</option>
                                <option value="8" @php check_select($current_default_item_decimals, '8'); @endphp>8</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[quote_overview_period]" id="settings[quote_overview_period]"
                                class="form-control simple-select" data-minimum-results-for-search="Infinity">
                                <option value="this-month" @php check_select(get_setting('quote_overview_period'), 'this-month'); @endphp>
                                    @@lang('this_month')
                                </option>
                                <option value="last-month" @php check_select(get_setting('quote_overview_period'), 'last-month'); @endphp>
                                    @@lang('last_month')
                                </option>
                                <option value="this-quarter" @php check_select(get_setting('quote_overview_period'), 'this-quarter'); @endphp>
                                    @@lang('this_quarter')
                                </option>
                                <option value="last-quarter" @php check_select(get_setting('quote_overview_period'), 'last-quarter'); @endphp>
                                    @@lang('last_quarter')
                                </option>
                                <option value="this-year" @php check_select(get_setting('quote_overview_period'), 'this-year'); @endphp>
                                    @@lang('this_year')
                                </option>
                                <option value="last-year" @php check_select(get_setting('quote_overview_period'), 'last-year'); @endphp>
                                    @@lang('last_year')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[invoice_overview_period]" id="settings[invoice_overview_period]"
                                class="form-control simple-select" data-minimum-results-for-search="Infinity">
                                <option value="this-month" @php check_select(get_setting('invoice_overview_period'), 'this-month'); @endphp>
                                    @@lang('this_month')
                                </option>
                                <option value="last-month" @php check_select(get_setting('invoice_overview_period'), 'last-month'); @endphp>
                                    @@lang('last_month')
                                </option>
                                <option value="this-quarter" @php check_select(get_setting('invoice_overview_period'), 'this-quarter'); @endphp>
                                    @@lang('this_quarter')
                                </option>
                                <option value="last-quarter" @php check_select(get_setting('invoice_overview_period'), 'last-quarter'); @endphp>
                                    @@lang('last_quarter')
                                </option>
                                <option value="this-year" @php check_select(get_setting('invoice_overview_period'), 'this-year'); @endphp>
                                    @@lang('this_year')
                                </option>
                                <option value="last-year" @php check_select(get_setting('invoice_overview_period'), 'last-year'); @endphp>
                                    @@lang('last_year')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[disable_quickactions]" class="form-control simple-select"
                                ...
                                <option value="1" @php check_select(get_setting('disable_quickactions'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[reports_in_new_tab]" id="settings[reports_in_new_tab]"
                                class="form-control simple-select" data-minimum-results-for-search="Infinity">
                                <option value="0">@@lang('no')</option>
                                <option value="1" @php check_select(get_setting('reports_in_new_tab'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[show_responsive_itemlist]" id="settings[show_responsive_itemlist]"
                                ...
                                <option value="1" @php check_select(get_setting('show_responsive_itemlist'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="settings[bcc_mails_to_admin]" id="settings[bcc_mails_to_admin]"
                                class="form-control simple-select" data-minimum-results-for-search="Infinity">
                                <option value="0">@@lang('no')</option>
                                <option value="1" @php check_select(get_setting('bcc_mails_to_admin'), '1'); @endphp>
                                    @@lang('yes')
                                </option>
                            </select>
