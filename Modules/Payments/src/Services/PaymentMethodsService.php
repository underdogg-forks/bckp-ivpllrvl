...
class PaymentMethodsService extends BaseService
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Collection|\Modules\Payments\app\Models\PaymentMethod[] collection of PaymentMethod models
     */
    public function getAll()
    {
        return \Modules\Payments\app\Models\PaymentMethod::query()->get();
    }
}
