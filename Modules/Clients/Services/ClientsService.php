...
class ClientsService extends BaseService
{
    ...
    {
        return Client::query()->select(['*', DB::raw('CONCAT(client_name, " ", client_surname) as client_fullname')]);
    }
    ...
    {
        return Client::query()->orderBy('client_name');
    }
    ...
    public function clientLookup(string $client_name): int
    {
        ...
        $newClient = Client::create(['client_name' => $client_name]);
    ...
    {
        return Client::query()->withSum('invoices as client_invoice_total', 'invoice_total');
    }
    ...
    {
        return Client::query()->withSum('invoices as client_invoice_paid', 'invoice_paid');
    }
    ...
    {
        return Client::query()->withSum('invoices as client_invoice_balance', 'invoice_balance');
    }
    ...
    {
        return Client::query()->where('client_active', 0);
    }
    ...
    {
        return Client::query()->where('client_active', 1);
    }
