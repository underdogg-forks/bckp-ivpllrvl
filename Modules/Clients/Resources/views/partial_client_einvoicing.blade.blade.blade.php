...
foreach ($req_einvoicing->users as $user_id => $user) {
    ...
    <div
        ...
        <div class="form-group" data-toggle="tooltip" data-placement="top" title="@php
            ...
            <div class="table-responsive">
                <table class="table table-hover table-condensed table-bordered no-margin">
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="min-width:20%;">@@lang('client')</th>
                        <th class="text-center" style="min-width:20%;">{{ $user_link }}</th>
                    </tr>
                    </thead>
                    <tfoot>
                    <tr>
                        <th colspan="3" class="text-center alert-{{ $me ? 'danger' : 'warning' }}"
                            title="@@lang('username')">
                            <small class="te te-1 dib"><i class="fa fa-fw fa-user"></i>@php
                                    _htmlsc($user->user_name);
                                @endphp</small>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {{ anchor('users/form/' . $user_id . '#user_' . $key, $u_icon, $title_tip . ' ' . htmlsc($user->user_name) . ' #' . trans($lang[$l]) . ' (' . mb_trim(trans('field')) . ')"') }}
                        </td>
                    </tr>
                    @php
                        }
