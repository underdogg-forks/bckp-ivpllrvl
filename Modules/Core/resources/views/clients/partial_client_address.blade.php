...
<span class="client-adress-town-line">
    {{ $client->client_city ? htmlsc($client->client_city) . ' partial_client_address.blade.php' : '' }}
    {{ $client->client_state ? htmlsc($client->client_state) . ' partial_client_address.blade.php' : '' }}
