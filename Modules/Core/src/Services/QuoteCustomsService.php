...
class QuoteCustomsService extends BaseService
{
    ...
    {
        DB::select('SQL_CALC_FOUND_ROWS ip_quote_custom.*, ip_custom_fields.*', false);
    }
    ...
    {
        DB::join('ip_custom_fields', 'ip_quote_custom.quote_custom_fieldid = ip_custom_fields.custom_field_id');
    }
    ...
    {
        DB::where('ip_quote_custom.quote_id', $quote_id);
