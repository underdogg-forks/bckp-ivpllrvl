<x-layouts.app>
    ...
    <div class="mb-6 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">{{ trans('ip.Password') }}</span>
    </div>

    <!-- Page Title -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ trans('ip.Update password') }}</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ trans('ip.Ensure your account is using a long, random password to stay secure') }}
        </p>
    </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <form class="max-w-md mb-10" action="{{ route('settings.password.update') }}" method="POST">
                            ...
                            <div>
                                <x-button type="primary">{{ trans('ip.Update Password') }}</x-button>
                            </div>
                        </form>
                    </div>
                </div>
