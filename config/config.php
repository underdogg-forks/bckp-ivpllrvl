...
|
*/
$config['legacy_calculation'] = env('LEGACY_CALCULATION', 'true');
...
|
*/
$config['enable_invoice_deletion'] = env('ENABLE_INVOICE_DELETION');
...
|
*/
$config['disable_read_only'] = env('DISABLE_READ_ONLY');
...
|
*/
$config['index_page'] = env('REMOVE_INDEXPHP') ? '' : 'index.php';
...
|--------------------------------------------------------------------------
|
| This determines which set of lang files should be used. Make sure
...
|
*/
$config['log_threshold'] = env('IP_DEBUG') ? 2 : 1;
